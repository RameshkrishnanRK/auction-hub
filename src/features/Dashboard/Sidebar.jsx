...
const Sidebar = ({subCatData, setSubCatData}) => {
    ...
    useEffect(()=>{
        if(subCatData) {
          ...
          console.log('sideBar:', subCatData1)
        };
        },[subCatData]);
    ...
    const categoryOnlyData= getuniqueData(productsData,'subCatType');
                                                ...
                                                <Collapse in={openCategories[category.name]} timeout="auto" unmountOnExit>
                                                    <List component="div" disablePadding>
                                                        {category.subcategories.map((subcategory, subIndex) => (
                                                            ...
                                                            >
                                                                <ListItemText style={{ cursor: 'pointer' }} valu={subcategory.name}  onClick={(e) => handleSubcategoryClick(e, subcategory.name)} primary={subcategory.name} />
                                                                 {/* <button key={subIndex} type="button" name='subCatType'  >{subcategory.name}</button> */}
                                                            </ListItem>
                                                        ))}
                                                    </List>
                                                </Collapse>
