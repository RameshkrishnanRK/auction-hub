...
import { Box, Container, Typography, Button, FormControl, Select, MenuItem, InputLabel, RadioGroup, FormControlLabel, Radio, Grid } from '@mui/material';
      ...
      <Container className= {styles.mainContainer }>
        ...
        <Box className={styles.title}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={4} sm={5}>
              <FormControl className={styles.boxStyle}  fullWidth margin="normal">
        ...
        <FormSection className={styles.categoryContainer}>
          ...
          <FormControl fullWidth margin="normal"className={styles.boxStyle}>
            ...
            <Select className={styles.regionSelect}  value={region} onChange={handleRegionChange}>
              <MenuItem value="" >
                <em>Select Region</em>
              </MenuItem>
