...
const Sell = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile && allowedFileTypes.includes(selectedFile.type)) {
      ...
      setFile(null);
      setFileErrorMessage(
        "Only JPEG, JPG, PNG and JFIF formates are supported",
      );
    }
  };
      ...
      <Layout>
        ...
        <Box className={styles.footer} mt={2}>
          <Typography className={styles.footerText} fontSize="small">
            © Copyright 2024 KPMG India. All Rights Reserved. No part of this
            web page may be reproduced in any way without the prior written
            permission of KPMG India.
          </Typography>
        </Box>
      </Layout>
    </>
